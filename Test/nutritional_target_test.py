...
class NutritionalTargetsTest(unittest.TestCase):
    ...
    def test_adjust_invalid_macros(self):
        ...
        for target in self.INVALID_TARGETS:
            ...
            self.assertLessEqual(target['calories'],calculate_macro_calories(min_max_proteins[1],min_max_fats[1],min_max_carbs[1]))
            self.assertGreaterEqual(target['calories'],calculate_macro_calories(min_max_proteins[0],min_max_fats[0],min_max_carbs[0]))
