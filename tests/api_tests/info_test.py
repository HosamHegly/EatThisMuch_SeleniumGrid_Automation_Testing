...
class CardInfoTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.card_info = CardsInfo(self.my_api)
        self.card_info_json = self.card_info.get_info()

    def test_info_endpoint_status_code(self):
        status_code = self.card_info.get_status_code()
    ...
    def test_info_endpoint_schema(self):
        ...
        try:
            validate(instance=self.card_info_json, schema=schema)
    ...
    def test_info_endpoint_response_body(self):
        ...
        for category in expected_info:
            try:
                self.assertEqual(self.card_info_json[category], expected_info[category],
