...
from test.uiTests.nutritional_target_input_values_test import *  # Import the tests case

from test.uiTests.nutritional_target_input_values_test import NutritionalTargetsValuesTest
